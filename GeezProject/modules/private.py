...
# Tapi Jangan di Hapus Special Thanks To nya Yaaa :'D
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "💬 Channel Updates", url=f"https://t.me/freeProjectsCh"), 
                    InlineKeyboardButton(
                        "🎈 Group Support", url=f"https://t.me/FreeSuportGroup")
                ],[
                    InlineKeyboardButton(
                        "🛠 Source Code 🛠", url=f"https://{SOURCE_CODE}")
                ],[
                    InlineKeyboardButton(
                        "🎁 Donate", url=f"https://t.me/RxyzBOS")
                ]
            ]
        ),
      ...
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "Created By", url=f"https://t.me/RxyzBOS"
                    )
                ]
            ]
        )
